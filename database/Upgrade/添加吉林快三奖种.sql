...
SELECT @ltid, N'吉林快三', 'jlk3', 1, 99, 0, 0, 0, @sort, @lttype, 0, 7, N'', 0, 
	0, @msort, N'当日9点30分至当日22点40分', 87, @iss
WHERE NOT EXISTS(SELECT 1 FROM Sys_Lottery WHERE Code='jlk3');

DECLARE @num INT = 1, 
		@sn NVARCHAR(100) = '001', 
		@time NVARCHAR(10) = '08:29:00'
