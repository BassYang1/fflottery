<%@ Page Language="C#" AutoEventWireup="true" Inherits="Lottery.WebApp.contract.ContractgzOper"
    CodeBehind="ContractgzOper.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        function ajaxGetList() {
            ...
            $.ajax({
                ...
                url: "/ajax/ajaxContractGz.aspx?oper=ajaxContractgzOperInfo",
                ...
                success: function (d) {
                    var html = "";
                        ...
                        html += '</tr>';
                        html += '<tr>';
                        html += '<td class="type w120">本期销量：</td>';
                        html += '<td><em>' + d.bet + '</em></td>';
                        html += '<td class="type w120">日结比率：</td>';
                        html += '<td><em>' + d.per + '%</em></td>';
                        html += '</tr>';
                        html += '<tr>';
                        html += '<td class="type w120">日结工资：</td>';
                        html += '<td><em>' + d.money + '</em></td>';
                        html += '<td class="type w120"></td>';
                        html += '<td><em></em></td>';
                        html += '</tr>';
                        html += '</table>';
                        $("#list").html(html);
        ...
        function PaifaContractFH() {
            ...
            $.ajax({
                type: "post",
                dataType: "json",
                url: "/ajax/ajaxContractGZ.aspx?oper=PaifaContractFH&clienttime=" + Math.random(),
