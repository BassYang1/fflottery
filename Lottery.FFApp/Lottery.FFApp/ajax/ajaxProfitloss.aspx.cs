...
// Type: Lottery.WebApp.ajaxProfitloss
...
namespace Lottery.WebApp
{
  public partial class ajaxProfitloss : UserCenterSession
  {
    ...
    {
      this.q("keys");
      string d1 = this.q("d1") + " 00:00:00";
      string d2 = this.q("d2") + " 23:59:59";
      ...
      if (!string.IsNullOrEmpty(str1))
      {
        switch (str1)
        {
          ...
          case "3":
            ...
            dateTime3 = dateTime3.AddDays(0.0);
            d2 = dateTime3.ToString("yyyy-MM-dd") + " 23:59:59";
            break;
          case "4":
            d1 = DateTime.Now.ToString("yyyy-MM") + "-01 00:00:00";
            d2 = DateTime.Now.AddDays(0.0).ToString("yyyy-MM-dd") + " 23:59:59";
          ...
          case "5":
            ...
            dateTime4 = dateTime4.AddDays(0.0);
            d2 = dateTime4.ToString("yyyy-MM-dd") + " 23:59:59";
            break;
          case "6":
            d1 = DateTime.Now.ToString("yyyy") + "-01-01 00:00:00";
            d2 = DateTime.Now.AddDays(0.0).ToString("yyyy-MM-dd") + " 23:59:59";
