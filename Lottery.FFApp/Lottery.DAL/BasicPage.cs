...
namespace Lottery.DAL
{
    public class BasicPage : PageUI
    {
        ...
        protected void FinalMessage(string pageMsg, string go2Url, int BackStep, int Seconds)
        {
            ...
            if (BackStep > 0)
                stringBuilder.Append("<a href=\"javascript:history.go(" + (object)-BackStep + ")\"><button type='button' class='btn btn-primary'>立即跳转</button></a>\r\n");
            else
        ...
        protected void SetupSystemDate()
        {
            ...
            HttpContext.Current.Application["Lottery"] = (object)this.site;
