...
// Type: Lottery.DAL.GYoule11x5Check
...
{
  public static class GYoule11x5Check
  {
    public static void RunOfIssueNum(int LotteryId, string IssueNum)
    {
      GYoule11x5Check.DoWord doWord = new GYoule11x5Check.DoWord(GYoule11x5Check.Run);
      doWord.BeginInvoke(LotteryId, IssueNum, new AsyncCallback(GYoule11x5Check.CallBack), (object) doWord);
    }

    public static void CallBack(IAsyncResult r)
    {
      GYoule11x5Check.DoWord asyncState = (GYoule11x5Check.DoWord) r.AsyncState;
    }
