  ...
  public partial class ajaxBet : UserCenterSession
  {
    ...
    private void ajaxGetList()
    {
      ...
      if (str2.Trim().Length > 0 && str3.Trim().Length > 0)
        _wherestr1 = _wherestr1 + " and STime2 >='" + str2 + "' and STime2 <='" + str3 + "'";
      if (!string.IsNullOrEmpty(str6))
        _wherestr1 = _wherestr1 + " and State =" + str6;
      if (!string.IsNullOrEmpty(str7))
        _wherestr1 = _wherestr1 + " and SingleMoney ='" + str7 + "'";
      if (!string.IsNullOrEmpty(str8))
        _wherestr1 = _wherestr1 + " and Id =" + str8;
      string _jsonstr = "";
      new Lottery.DAL.UserBetDAL().GetListJSON(_thispage, _pagesize, _wherestr1, this.AdminId, ref _jsonstr);
    ...
    private void ajaxGetZHInfo()
    {
      ...
      string _jsonstr = "";
      new UserBetZhDAL().GetListJSON_ZHDetail(_thispage, _pagesize, _wherestr1, "", ref _jsonstr);
      this._response = _jsonstr;
    }

    private void ajaxOper()
    {
      this._response = new Lottery.DAL.Flex.UserBetDAL().BetCancel(this.f("ids"));
    }
    ...
    private void ajaxZHIssueNum()
    {
      ...
      else
      {
        ...
        for (int index = 0; index < dataTable1.Rows.Count; ++index)
        {
          ...
          if (lotteryId == "1010" || lotteryId == "1017" || (lotteryId == "1011" || lotteryId == "1012") || (lotteryId == "1013" || lotteryId == "3004") || lotteryId == "3005")
