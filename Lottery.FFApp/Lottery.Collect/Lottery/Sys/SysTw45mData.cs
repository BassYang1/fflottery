...
namespace Lottery.Collect.Sys
{
    ...
    /// 台湾45秒彩
    /// </summary>
    public class SysTw45mData : SysBase
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(SysTw45mData));
        private static SysBase Lottery = new SysTw45mData();
