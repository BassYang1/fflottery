...
namespace Lottery.Collect.Sys
{
    ...
    /// 新加坡30秒
    /// </summary>
    public class SysXjp30mData : SysBase
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(SysXjp30mData));
        private static SysBase Lottery = new SysXjp30mData();

        public SysXjp30mData()
            : base("xjp30m", "新加坡30秒")
        {
            base.NumberCount = 5;
