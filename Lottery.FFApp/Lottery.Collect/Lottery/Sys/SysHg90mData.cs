...
namespace Lottery.Collect.Sys
{
    ...
    /// 韩国1.5分彩
    /// </summary>
    public class SysHg90mData : SysBase
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(SysHg90mData));
        private static SysBase Lottery = new SysHg90mData();
