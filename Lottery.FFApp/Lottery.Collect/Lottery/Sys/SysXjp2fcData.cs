...
namespace Lottery.Collect.Sys
{
    ...
    /// 新加坡2分彩
    /// </summary>
    public class SysXjp2fcData : SysBase
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(SysXjp2fcData));
        private static SysBase Lottery = new SysXjp2fcData();

        public SysXjp2fcData()
            : base("xjp2fc", "新加坡2分彩")
        {
            base.NumberCount = 5;
