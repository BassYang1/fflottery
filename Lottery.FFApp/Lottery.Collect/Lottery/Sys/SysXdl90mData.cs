...
namespace Lottery.Collect.Sys
{
    ...
    /// 新德里1.5分彩
    /// </summary>
    public class SysXdl90mData : SysBase
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(SysXdl90mData));
        private static SysBase Lottery = new SysXdl90mData();

        public SysXdl90mData()
            : base("xdl90m", "新德里1.5分彩")
        {
            base.NumberCount = 5;
