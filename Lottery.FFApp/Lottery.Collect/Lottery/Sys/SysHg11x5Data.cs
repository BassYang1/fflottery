...
namespace Lottery.Collect.Sys
{
    ...
    /// 韩国1.5分11选5
    /// </summary>
    public class SysHg11x5Data : SysBase
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(SysHg11x5Data));
        private static SysBase Lottery = new SysHg11x5Data();

        public SysHg11x5Data()
            : base("hg11x5", "韩国1.5分11选5")
        {
            base.NumberCount = 5;
