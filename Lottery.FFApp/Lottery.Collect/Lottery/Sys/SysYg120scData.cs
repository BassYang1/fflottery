...
namespace Lottery.Collect.Sys
{
    ...
    /// 英国120秒赛车
    /// </summary>
    public class SysYg120scData : SysBase
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(SysYg120scData));
        private static SysBase Lottery = new SysYg120scData();

        public SysYg120scData()
            : base("yg120sc", "英国120秒赛车")
        {
            base.NumberCount = 10;
