...
namespace Lottery.Collect.Sys
{
    ...
    /// 东京1.5分彩
    /// </summary>
    public class SysDj15Data : SysBase
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(SysDj15Data));
        private static SysBase Lottery = new SysDj15Data();
