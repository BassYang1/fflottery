...
namespace Lottery.Collect.Boyi
{
    ...
    public class OfficialLotteryData
    {
        ...
        { 
            ...
            //吉林快三 jlk3
            ThreadPool.QueueUserWorkItem(new WaitCallback(UpdateData), "jlk3");

            //北京快三 bjk3
            ThreadPool.QueueUserWorkItem(new WaitCallback(UpdateData), "bjk3");

            //海南快三 hnk3
            ThreadPool.QueueUserWorkItem(new WaitCallback(UpdateData), "hnk3");

            //香港六合彩 hk6
            ThreadPool.QueueUserWorkItem(new WaitCallback(Hk6Data.Hk6), "hk6");
        }
