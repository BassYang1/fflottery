...
// Type: Lottery.Admin.ajaxAutoRank
...
{
  public partial class ajaxAutoRank : AdminCenter
  {
    ...
    private void ajaxGetList()
    {
      ...
      string sql0 = SqlHelp.GetSql0("*", "Sys_AutoRank", "id", num2, num1, "asc", whereStr);
      this.doh.Reset();
    ...
    private void ajaxStates()
    {
      ...
      int int32 = Convert.ToInt32(this.doh.GetField("Sys_AutoRank", "IsUsed"));
      this.doh.Reset();
      this.doh.ConditionExpress = "id=" + str;
      this.doh.AddFieldItem("IsUsed", (object) (int32 == 0 ? 1 : 0));
      if (this.doh.Update("Sys_AutoRank") > 0)
    ...
    private void ajaxDel()
    {
      ...
      this.doh.Reset();
      this.doh.ConditionExpress = "id=" + str;
      if (this.doh.Delete("Sys_AutoRank") > 0)
