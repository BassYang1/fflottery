...
{
  public partial class betCancel : AdminCenter
  {
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
      if (this.rbo1.Checked)
      {
        ...
        {
          new LotteryCheck().Cancel(Convert.ToInt32(this.ddlLottery.SelectedItem.Value), this.txtIssue.Text.Trim(), 2);
