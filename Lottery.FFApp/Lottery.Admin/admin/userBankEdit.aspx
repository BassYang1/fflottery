<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userBankEdit.aspx.cs" Inherits="Lottery.Admin.userBankEdit" %>
...
<body>
    ...
    <table class="formtable">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtPayBank" runat="server" MaxLength="50" Width="300" CssClass="ipt" Enabled="false"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <asp:TextBox ID="txtPayName" runat="server" MaxLength="50" Width="300" CssClass="ipt" Enabled="false"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <asp:TextBox ID="txtPayAccount" runat="server" MaxLength="50" Width="300" CssClass="ipt"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <th>
                开户地址</th>
            <td>
                <asp:TextBox ID="txtPayBankAddress" runat="server" MaxLength="50" Width="300" CssClass="ipt"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <th>
    ...
    <div class="popup-actions">
        ...
        <asp:Button ID="btnSave" runat="server" Text="编辑银行" CssClass="btn btn-primary" OnClick="btnSave_Click" />
    </div>
    </form>
