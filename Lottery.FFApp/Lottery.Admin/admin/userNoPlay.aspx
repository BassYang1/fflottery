<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userNoPlay.aspx.cs" Inherits="Lottery.Admin.userNoPlay" %>
...
<head>
    ...
    <title>设置会员玩法,选中表示禁止投注该玩法！</title>
...
<body>
    <div class="popup-body">
        ...
        <table class="formtable">
            <tr>
                <td>
                    <asp:DropDownList ID="ddlLot" runat="server" OnSelectedIndexChanged="ddlLot_SelectedIndexChanged"
                        AutoPostBack="True" Width="150px" Height="30px">
                    </asp:DropDownList>
                </td>
                <td>
