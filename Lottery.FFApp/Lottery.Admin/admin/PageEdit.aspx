<%@ Page Language="C#" CodeBehind="PageEdit.aspx.cs" Inherits="Lottery.Admin.PageEdit" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            s += '<div class="uc-box">';
            s += '<div class="box-hd">';
            s += '<h3 class="title">设置操作</h3><a href="javascript:;" class="back-top"><i class="icon icon-top"></i>TOP</a>';
            s += '<i class="icon-t"></i>';
            s += '</div>';
            s += '<div class="box-bd">';
            s += '<div class="uc-form">';
