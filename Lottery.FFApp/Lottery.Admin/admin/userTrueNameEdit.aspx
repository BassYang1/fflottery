<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userTrueNameEdit.aspx.cs" Inherits="Lottery.Admin.userTrueNameEdit" %>
    ...
    <table class="formtable">
        ...
        <tr>
         ...
         <tr>
            ...
            <td>
                <asp:TextBox ID="txtTrueName" runat="server" MaxLength="50" Width="300" CssClass="ipt"></asp:TextBox>
            </td>
        </tr>
    </table>
    <div class="popup-actions">
        <asp:Label ID="lblmsg" runat="server"></asp:Label>
        <asp:Button ID="btnSave" runat="server" Text="确认编辑" CssClass="btn btn-primary" OnClick="btnSave_Click" />
    </div>
    </form>
