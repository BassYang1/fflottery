<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userUpdatePoint.aspx.cs"
    Inherits="Lottery.Admin.userUpdatePoint" %>
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtName" runat="server" Width="200px" MaxLength="20" CssClass="ipt"
                Enabled="false"></asp:TextBox>
                 <asp:TextBox ID="txtId" runat="server" MaxLength="20" CssClass="ipt" Visible="false"
