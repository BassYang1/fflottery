...
// Type: Lottery.Admin.ajaxAdminLoginCheck
...
{
  public partial class ajaxAdminLoginCheck : AdminCenter
  {
    ...
    private void ajaxGetList()
    {
      ...
      string whereStr = " CheckType=0";
      this.doh.Reset();
      this.doh.ConditionExpress = whereStr;
      int totalCount = this.doh.Count("Sys_LoginCheck");
      string sql0 = SqlHelp.GetSql0("*", "Sys_LoginCheck", "id", num2, num1, "asc", whereStr);
      this.doh.Reset();
    ...
    private void ajaxStates()
    {
      ...
      int int32 = Convert.ToInt32(this.doh.GetField("Sys_LoginCheck", "IsUsed"));
      this.doh.Reset();
      this.doh.ConditionExpress = "id=" + str;
      this.doh.AddFieldItem("IsUsed", (object) (int32 == 0 ? 1 : 0));
      if (this.doh.Update("Sys_LoginCheck") > 0)
    ...
    private void ajaxDel()
    {
      ...
      this.doh.Reset();
      this.doh.ConditionExpress = "id=" + str;
      if (this.doh.Delete("Sys_LoginCheck") > 0)
