<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userBankUnLock.aspx.cs" Inherits="Lottery.Admin.userBankUnLock" %>
...
<body>
    ...
    <div class="popup-actions">
        ...
        <asp:Button ID="btnSave" runat="server" Text="解绑银行" CssClass="btn btn-primary" OnClick="btnSave_Click" />
    </div>
    </form>
