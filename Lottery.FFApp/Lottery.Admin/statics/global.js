...
site.Name = '时时彩';
site.Name2 = '时时彩';
site.Url = 'http://localhost:11040';
site.SiteID = '';
site.Dir = '/';
site.CookieDomain = '';
site.CookiePrev = 'jcmsV700';
site.AllowReg = true;
site.CheckReg = false;
...
function _jcms_Dialog(styletype, title, width, height, iswhat, showCloseBox) {
    ...
    this.open = function (_sUrl, _returnFunc, _sMode) {
        ...
        $i("dialogBody").innerHTML = "<iframe id='dialogFrame' name='dialogFrame' src='" + site.Dir + "statics/loading.html' width='" + oWidth + "' height='" + oHeight + "' frameborder='no' border='0' marginwidth='0' marginheight='0' scrolling='" + _sMode + "'></iframe>";
...
function _jcms_GetRefreshCode(obj, h) {
    if (!h)
        $i(obj).src = _jcms_SetUrlRefresh(site.Dir + "statics/plus/getcode.aspx");
    else
        $i(obj).src = _jcms_SetUrlRefresh(site.Dir + "statics/plus/getcode.aspx?h=" + h);
}
/*当前网站访问者信息*/
var user = new Object();
